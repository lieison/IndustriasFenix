...
<div class="yit-progress-bar text-<?php echo esc_attr( $text_position . $animate . $vc_css ) ?>" <?php echo $animate_data ?>>
    <?php if ( $text_position != 'after' ):  ?>
        <div class="bar-meta" <?php echo $inside_style ?>><span class="bar-title" <?php echo $style_title ?>><?php echo $title ?></span> <span class="bar-value" <?php echo $style_title ?>></span></div>
    <?php endif; ?>
